...
locals {
  github-email    = "cagatayakkiran3757@gmail.com"   # you need to change this line
  github-username = "cagatayakk"               # you need to change this line
  github-token    = "ghp_XXXXXXXXXXXXXXXXXXXXXXXXX"   # you need to change this line
  key_pair        = "cagatayakk"                       # you need to change this line
  pem_key_address = "~/.ssh/cagatayakk.pem" # you need to change this line
}
